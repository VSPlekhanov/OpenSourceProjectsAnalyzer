from Metrics.releases_info import releases_info
from Metrics import project_usage
...
metrics_list = [commit_freq, issues_activity, is_company, project_usage, releases_info]
